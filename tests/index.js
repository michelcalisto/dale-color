import tests from 'tape';
import daleColor from  '../build/dale-color.js'

tests('Test de validaciones:', (t) => {
    t.same(daleColor.validaciones.isHex("#64C800"), true, 'Debería ser: true');
    t.same(daleColor.validaciones.isHex("#64C800F"), false, 'Debería ser: false');
    t.same(daleColor.validaciones.isHex("#64C80"), false, 'Debería ser: false');
    t.same(daleColor.validaciones.isHex("164C800"), false, 'Debería ser: false');
    t.same(daleColor.validaciones.isHex("#64CX00"), false, 'Debería ser: false');

    t.same(daleColor.validaciones.isPorcentaje(0), true, 'Debería ser: true');
    t.same(daleColor.validaciones.isPorcentaje(100), true, 'Debería ser: true');
    t.same(daleColor.validaciones.isPorcentaje(-1), false, 'Debería ser: false');
    t.same(daleColor.validaciones.isPorcentaje(101), false, 'Debería ser: false');
    t.same(daleColor.validaciones.isPorcentaje("sol"), false, 'Debería ser: false');
